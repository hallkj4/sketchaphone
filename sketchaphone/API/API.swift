...
public final class LockGameMutation: GraphQLMutation {
  public static let operationString =
    "mutation lockGame($id: ID!) {\n  lockGame(id: $id) {\n    __typename\n    ...GameDetailed\n  }\n}"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("lockGame", arguments: ["id": GraphQLVariable("id")], type: .nonNull(.object(LockGame.selections))),
    ]
    ...
    public init(lockGame: LockGame) {
      self.init(snapshot: ["__typename": "Mutation", "lockGame": lockGame.snapshot])
    }

    public var lockGame: LockGame {
      get {
        return LockGame(snapshot: snapshot["lockGame"]! as! Snapshot)
      }
      set {
        snapshot.updateValue(newValue.snapshot, forKey: "lockGame")
      }
    }

    public struct LockGame: GraphQLSelectionSet {
      public static let possibleTypes = ["OpenGame", "CompletedGame"]
      ...
      public static func makeOpenGame(id: GraphQLID, turns: [Turn], flags: [Flag]) -> LockGame {
        return LockGame(snapshot: ["__typename": "OpenGame", "id": id, "turns": turns.map { $0.snapshot }, "flags": flags.map { $0.snapshot }])
      }

      public static func makeCompletedGame(id: GraphQLID, turns: [Turn], flags: [Flag]) -> LockGame {
        return LockGame(snapshot: ["__typename": "CompletedGame", "id": id, "turns": turns.map { $0.snapshot }, "flags": flags.map { $0.snapshot }])
      }
...
public final class ReleaseGameMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("releaseGame", arguments: ["id": GraphQLVariable("id")], type: .nonNull(.object(ReleaseGame.selections))),
    ]
...
public final class StartGameMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct StartGame: GraphQLSelectionSet {
      ...
      public static func makeOpenGame(id: GraphQLID) -> StartGame {
        return StartGame(snapshot: ["__typename": "OpenGame", "id": id])
      }

      public static func makeCompletedGame(id: GraphQLID) -> StartGame {
        return StartGame(snapshot: ["__typename": "CompletedGame", "id": id])
      }
...
public final class TakeTurnMutation: GraphQLMutation {
  public static let operationString =
    "mutation takeTurn($gameId: ID!, $phrase: String, $drawing: S3ObjectInput) {\n  takeTurn(gameId: $gameId, phrase: $phrase, drawing: $drawing) {\n    __typename\n    id\n  }\n}"

  public var gameId: GraphQLID
  public var phrase: String?
  public var drawing: S3ObjectInput?

  public init(gameId: GraphQLID, phrase: String? = nil, drawing: S3ObjectInput? = nil) {
    self.gameId = gameId
    self.phrase = phrase
  ...
  public var variables: GraphQLMap? {
    return ["gameId": gameId, "phrase": phrase, "drawing": drawing]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("takeTurn", arguments: ["gameId": GraphQLVariable("gameId"), "phrase": GraphQLVariable("phrase"), "drawing": GraphQLVariable("drawing")], type: .nonNull(.object(TakeTurn.selections))),
    ]
    ...
    public struct TakeTurn: GraphQLSelectionSet {
      ...
      public static func makeOpenGame(id: GraphQLID) -> TakeTurn {
        return TakeTurn(snapshot: ["__typename": "OpenGame", "id": id])
      }

      public static func makeCompletedGame(id: GraphQLID) -> TakeTurn {
        return TakeTurn(snapshot: ["__typename": "CompletedGame", "id": id])
      }
...
public final class OpenGamesQuery: GraphQLQuery {
  public static let operationString =
    "query openGames {\n  openGames {\n    __typename\n    ...OpenGameDetailed\n  }\n}"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("openGames", type: .nonNull(.list(.nonNull(.object(OpenGame.selections))))),
    ]
    ...
    public init(openGames: [OpenGame]) {
      self.init(snapshot: ["__typename": "Query", "openGames": openGames.map { $0.snapshot }])
    }

    public var openGames: [OpenGame] {
      get {
        return (snapshot["openGames"] as! [Snapshot]).map { OpenGame(snapshot: $0) }
      }
      set {
        snapshot.updateValue(newValue.map { $0.snapshot }, forKey: "openGames")
      }
    }

    public struct OpenGame: GraphQLSelectionSet {
      public static let possibleTypes = ["OpenGame"]
